...
class BoardState < ApplicationRecord
  ...
  class << self
    ...
    def make_dijkstra_information(game_id)
      routing = {}
      field_index = []
    ...
    def generate_board_fields(size_of_board_edge, game_id)
      obstacles = 0
    ...
    def is_obstacle(terrain_string)
      obstacles = %w[
        tree
        house
      ]
    ...
    def terrain_with_obstacle_chance_selector
    ...
    def find_valid_obstacle_placement(size_of_board_edge)
