FactoryBot.define do
  ...
  factory :SummonedMinion do
    ...
    after :build do |minion, options|
      minion.owner_id = options.owner_id
      minion.owner = options.owner
    end
  end

  factory :BoardState do
